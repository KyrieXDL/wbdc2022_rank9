...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        embedding = torch.cat([embedding_text, embedding_video], dim=1)
        mask = torch.cat([text_mask, video_mask], dim=1)
        # embedding = torch.cat([embedding_video, embedding_text], dim=1)
        ...
        return (sequence_output, pooled_output) + encoder_outputs[1:] + (embedding_text, embedding_video)
