...
# '00': 0
CATEGORY_ID_TO_LV1ID = {k: v for v, k in enumerate(LV1_CATEGORY_ID_LIST)}
# 0: '00'
LV1ID_TO_CATEGORY_ID = {v: k for v, k in enumerate(LV1_CATEGORY_ID_LIST)}
...
def category_id_to_lv1id_2(category_id):
    return CATEGORY_ID_TO_LV1ID[category_id]


def lv1id_to_category_id_2(lv1id: int) -> str:
    """ Convert level-2 class id to string category_id. """
    return LV1ID_TO_CATEGORY_ID[lv1id]
