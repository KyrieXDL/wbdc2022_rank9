...
from utils.util import setup_device, setup_seed, setup_logging, build_optimizer2, evaluate, init_distributed_mode, \
...
def train_and_validate(args):
    ...
    optimizer, scheduler = build_optimizer2(args, model, t_total)
    if args.freeze:
