python -m torch.distributed.run --nproc_per_node=2 src/xdl_src/train.py \
    --flag 'base_clipvit_contras_not_e2e'\
    ...
    --device_ids '0,1' \
    --phase 'val'\
    --model_save_path './src/xdl_src/saved_models/base_clipvit_contras_not_e2e'\
    ...
    --use_swa\
    --use_fp16\
    --checkpoint './src/xdl_src/saved_models/pretrain_not_e2e/checkpoint_4.pth'\
