...
from models.BertModel1 import BertModel
...
class MultiModalLarge(nn.Module):
    def __init__(self, args):
        ...
        self.bert = BertModel(config=bert_config, add_pooling_layer=False, fusion_layer=self.fusion_layer)
