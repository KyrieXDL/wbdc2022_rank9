...
model_urls = {
    "van_tiny": data_path + "/models_pretrain/van_tiny_754.pth.tar",
    "van_small": data_path + "/models_pretrain/van_small_811.pth.tar",
    "van_base": data_path + "/models_pretrain/van_base_828.pth.tar",
    "van_large": data_path + "/models_pretrain/van_large_839.pth.tar",
}
