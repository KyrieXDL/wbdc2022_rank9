python src/test_src/inference_stack.py \
    ...
    --prefetch 8\
    --use_contrastive\
    --checkpoint './src/xdl_src/saved_models/base_clipvit_contras_not_e2e/model_swa.pth'\
    --checkpoint2 './src/xdl_src/saved_models/base_clipvit_contras_distill_not_e2e_v2/model_swa.pth'\
    --ckpt_file './src/bph_src/data/checkpoint/clip_roberta_base/model_swa.bin'\
    --ckpt_file2 './src/bph_src/data/checkpoint/clip_macbert_large/model_swa.bin'\
    --backbone 'clip_vit'\
    --fusion_layer 18\
