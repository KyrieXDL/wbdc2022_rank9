python src/eval_stack.py \
    ...
    --prefetch 8\
    --use_contrastive\
    --checkpoint './src/xdl_src/saved_models/base_clipvit_contras/model_swa720.pth'\
    --checkpoint2 './src/xdl_src/saved_models/base_clipvit_contras/model_swa723.pth'\
    --ckpt_file './src/bph_src/data/checkpoint/model_0731/roberta_model_base_709.bin'\
    --ckpt_file2 './src/bph_src/data/checkpoint/model_0731/large_macbert.bin'\
    --backbone 'clip_vit'\
    --fusion_layer 18\
